    ...
    <div className="py-8">
      ...
      {kpis && (
        <div className="grid grid-cols-2 gap-4 mb-6 md:grid-cols-5">
          <div className="glass-card p-4"><div className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Total Rows</div><div className="text-2xl font-bold gradient-text">{kpis.total.toLocaleString()}</div></div>
          <div className="glass-card p-4"><div className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Sum ({kpis.col})</div><div className="text-2xl font-bold">{Number(kpis.sum).toLocaleString()}</div></div>
          <div className="glass-card p-4"><div className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Average</div><div className="text-2xl font-bold">{kpis.avg}</div></div>
          <div className="glass-card p-4"><div className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Min</div><div className="text-2xl font-bold text-green-400">{kpis.min}</div></div>
          <div className="glass-card p-4"><div className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Max</div><div className="text-2xl font-bold text-purple-400">{kpis.max}</div></div>
        </div>
      )}
