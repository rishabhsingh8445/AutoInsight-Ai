    ...
    return (
      <div className="mx-auto max-w-2xl py-20 text-center page-enter page-enter-stagger-1">
        <div className="glass-card p-12">
          ...
          <p className="mt-2 text-[#71717a]">Upload a file to see analytics.</p>
    ...
    <div className="py-8">
      <div className="flex items-center justify-between mb-6 page-enter page-enter-stagger-1">
        <div className="hero-spotlight">
          ...
          <p className="text-sm text-[#71717a]">Interactive data exploration</p>
        </div>
      ...
      {kpis && (
        <div className="grid grid-cols-2 gap-4 mb-6 md:grid-cols-5 page-enter page-enter-stagger-2">
          {[
            { label: "Total Rows", value: kpis.total.toLocaleString(), color: "#6366f1" },
            ...
            >
              ...
              <div className="text-xs text-[#52525b] uppercase tracking-wider mb-1 font-mono relative z-10">{kpi.label}</div>
              ...
              {chartType === "bar" ? (
                ...
                <PieChart>
                  ...
                  <Pie data={chartData} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={110} label
                    ...
                    {chartData.map((_, i) => <Cell key={i} fill={COLORS[i % COLORS.length]} stroke="#050508" strokeWidth={2} />)}
                  </Pie>
                ...
                <ScatterChart>
                  <CartesianGrid strokeDasharray="3 3" stroke="#1a1a2a" />
                  <XAxis dataKey="x" name={activeX} tick={{ fill: "#52525b", fontSize: 11, fontFamily: "'JetBrains Mono', monospace" }} />
                  <YAxis dataKey="y" name={activeY} tick={{ fill: "#52525b", fontSize: 11, fontFamily: "'JetBrains Mono', monospace" }} />
            ...
            <div key={col} className="glass-card p-4" id={`secondary-chart-${idx}`}>
              ...
              <ResponsiveContainer width="100%" height={160}>
                <BarChart data={data} barSize={20}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#1a1a2a" />
                  <XAxis dataKey="name" tick={{ fill: "#52525b", fontSize: 9, fontFamily: "'JetBrains Mono', monospace" }} />
                  <YAxis tick={{ fill: "#52525b", fontSize: 9, fontFamily: "'JetBrains Mono', monospace" }} />
                  <Tooltip contentStyle={tooltipStyle} itemStyle={tooltipItemStyle} />
